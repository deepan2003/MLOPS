...
def home():
    ...
    return render_template_string(
        html_template, model_loaded=model_loaded, model_metadata=model_metadata
    )
...
def predict():
    ...
    try:
        ...
        # Log prediction
        logger.info(
            f"Prediction made: {prediction}, confidence: {result['confidence']:.3f}"
        )
