...
from model.predict_model import load_model_artifacts, predict_single, predict_batch
    ...
    train_data = pd.DataFrame(
        {
            ...
            "class": np.random.choice(
                ["positive", "negative"], n_samples, p=[0.3, 0.7]
            ),
        }
    )
...
def test_config():
    ...
    return {
        ...
        "evaluation": {"cv_folds": 3},  # Small for testing
    }
